            ...
            <nav className="bg-white shadow-md relative z-50">
                <div className="container mx-auto px-6 py-3 flex items-center justify-between">
                    ...
                    <div className="flex-grow flex justify-center">
                        <img src="/img/LogoNav.png" alt="LogoNav" className="w-24 md:w-32" />
                    </div>
            ...
            {isMenuOpen && (
                <div className="fixed bottom-20 right-4 bg-white p-4 rounded-lg shadow-xl md:hidden" style={{ zIndex: 9999 }}>
                    ...
                    <div className="flex space-x-2 py-2">
                        <img src="/img/flag/FRANCE.png" alt="FR" className="w-8 h-6 border border-black" />
                        <img src="/img/X.png" alt="X" className="w-6 h-6" />
                        <img src="/img/flag/COLOMBIE.png" alt="CO" className="w-8 h-6 border border-black" />
                    </div>
                </div>
            )}
